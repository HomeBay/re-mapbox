...
var Mapbox_LngLatBounds = require("../../Mapbox_LngLatBounds.bs.js");
...
function tToJs$2(data) {
  ...
  var tmp$12 = Belt_Option.map(data[/* maxBounds */13], Mapbox_LngLatBounds.tToJs);
  if (tmp$12) {
    tmp.maxBounds = tmp$12[0];
  }
  var tmp$13 = data[/* scrollZoom */14];
  if (tmp$13) {
    tmp.scrollZoom = tmp$13[0];
  }
  var tmp$14 = data[/* boxZoom */15];
  if (tmp$14) {
    tmp.boxZoom = tmp$14[0];
  }
  var tmp$15 = data[/* dragRotate */16];
  if (tmp$15) {
    tmp.dragRotate = tmp$15[0];
  }
  var tmp$16 = data[/* dragPan */17];
  if (tmp$16) {
    tmp.dragPan = tmp$16[0];
  }
  var tmp$17 = data[/* keyboard */18];
  if (tmp$17) {
    tmp.keyboard = tmp$17[0];
  }
  var tmp$18 = data[/* doubleClickZoom */19];
  if (tmp$18) {
    tmp.doubleClickZoom = tmp$18[0];
  }
  var tmp$19 = data[/* touchZoomRotate */20];
  if (tmp$19) {
    tmp.touchZoomRotate = tmp$19[0];
  }
  var tmp$20 = data[/* trackResize */21];
  if (tmp$20) {
    tmp.trackResize = tmp$20[0];
  }
  var tmp$21 = Belt_Option.map(data[/* center */22], Mapbox_LngLat.tToJs);
  if (tmp$21) {
    tmp.center = tmp$21[0];
  }
